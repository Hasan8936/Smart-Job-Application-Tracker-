    ...
    <div className="grid lg:grid-cols-3 gap-6">
      <section className="bg-surface border border-line rounded-xl2 shadow-card p-5 h-fit">
        ...
        <form onSubmit={analyze} className="space-y-3">
          ...
          <button disabled={busy} className="w-full inline-flex items-center justify-center gap-1.5 bg-accent text-accent-ink text-sm font-medium px-4 py-2.5 rounded-full hover:bg-accent-dark disabled:opacity-50"><Sparkles size={15} />{busy ? 'Analyzing...' : 'Generate suggestions'}</button>
        </form>
